Conference Room
=====================
This is a conference room project based on socket programming, for more details you can refer to project2.pdf.
...
* What do we have to do?
  ...
  You  have to  supply the  missing  code in  the files  'chatclient.c',
  'chatserver.c'  and 'chatlinker.c'.  The location  of missing  code is
...
* How do i test my programs? 
  ...
  You are supplied with executables 'goodchatserver' and 'goodchatclient'. These
...
* How do i run these programs? 
  ...
  The 'goodchatserver' program takes  a command line argument <groups-file>.
  For example you can run it as follows.

    % goodchatserver groups
 
  The 'goodchatclient' program doesn't take any arguments and you simply run
  it as
...
* Do these programs run on any machine? 
  ...
  They are compiled on zeus.ite.gmu.edu. They may work on other
  machines  with different  versions. First try  running and
  see. 
